...
#ifdef ACC_10HZ
#define $ACC_SAMPLE_PERIOD		100*1000 		// accelerate sample timer peroid 100ms
#define $LIS3DH_CTRL_REG1_VALUE 0x27	
#endif

#ifdef ACC_25HZ
#define $ACC_SAMPLE_PERIOD		40*1000 		// accelerate sample timer peroid 40ms
#define $LIS3DH_CTRL_REG1_VALUE 0x37	
#endif

#define $ACC_LSD				0.0000610351		
...
#define $LIS3DH_CTRL_REG4_VALUE 0x00
...
$acc_sample_disable_cmd_from_vm:
	...
	//M[$vee.accelerate.neck_protect.angle_x_init] = r1;
	//M[$vee.accelerate.neck_protect.angle_y_init] = r1;
	//M[$vee.accelerate.neck_protect.angle_z_init] = r1;	
