...
#ifndef _KOOVOX_SPORT_COMMON_PLUGIN_H_
#define _KOOVOX_SPORT_COMMON_PLUGIN_H_

#include <message.h>

extern const TaskData koovox_sport_common_plugin ;
