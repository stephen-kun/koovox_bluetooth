...
#ifndef KOOVOX
/* DSP -> VM */
#define HEARTRATE_VALUE_FROM_DSP		(0x4F20)
#define SPORT_DATA_FROM_DSP				(0x4F21)  
#define DRIVER_PROMPT_EVENT_FROM_DSP	(0x4F22) 
#define NECK_PROMPT_EVENT_FROM_DSP		(0x4f23)
#define HB_I2C_TEST_RESULT_FROM_DSP		(0x4f24)
#define ACC_I2C_TEST_RESULT_FROM_DSP	(0x4f25)
#define SEAT_PROMPT_EVENT_FROM_DSP		(0x4f26)
#define NOD_ACTION_EVENT_FROM_DSP		(0x4f27)
#define SHAKE_ACTION_EVENT_FROM_DSP		(0x4f28)
#define HB_ORIGIN_VALUE_FROM_DSP		(0x4087)
#define ACC_ORIGIN_VALUE_FROM_DSP		(0x4088)

/* VM -> DSP */
#define HB_SAMPLE_ENABLE_CMD_TO_DSP		(0x4F00)
#define HB_SAMPLE_DISABLE_CMD_TO_DSP	(0x4F01)
#define ACC_SAMPLE_ENABLE_CMD_TO_DSP	(0x4F02)
#define ACC_SAMPLE_DISABLE_CMD_TO_DSP	(0x4F03)
#define MUTE_MICROPHONE_CMD_TO_DSP		(0x4F04)
#define STEP_VALUE_ENABLE_CMD_TO_DSP	(0x4F05)
#define TIME_VALUE_ENABLE_CMD_TO_DSP	(0x4F06)
#define NECK_PROTECT_ENABLE_CMD_TO_DSP	(0x4F07)
#define SAFE_DRIVER_ENABLE_CMD_TO_DSP	(0x4F08)
#define RECOVER_HB_VALUE_CMD_TO_DSP		(0x4F09)
#define CONST_SEAT_ENABLE_CMD_TO_DSP	(0x4F0A)


/* LABRARY -> APP */
#define EVENT_SPORT_DSP_SHORT_MSG		(0x40c3)
#define EVENT_SPORT_DSP_LONG_MSG		(0x40c4)
#define EVENT_CVC_KALIMBA_LOADED		(0x40c5)
#define EVENT_KALIMBA_POWER_OFF			(0x40c6)
#define EVENT_CODEC_KALIMBA_LOADED		(0x40c7)
#define EVENT_SPORT_KALIMBA_LOADED		(0x40c8)
#endif
